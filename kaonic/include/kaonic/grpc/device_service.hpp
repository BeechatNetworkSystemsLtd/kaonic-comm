...
protected:
    device_service(const device_service&) = default;
    device_service(device_service&&) = default;

    device_service& operator=(const device_service&) = default;
    device_service& operator=(device_service&&) = default;
